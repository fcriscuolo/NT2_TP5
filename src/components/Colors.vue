<template>
  <div>
    ...
    <div id="container">
      <div class="square" :style="{'background-color':this.colors[0]}" @click="validar(0)"></div>
      <div class="square" :style="{'background-color':this.colors[1]}" @click="validar(1)"></div>
      <div class="square" :style="{'background-color':this.colors[2]}" @click="validar(2)"></div>
      <div class="square" :style="{'background-color':this.colors[3]}" @click="validar(3)" v-if="isHard"></div>
      <div class="square" :style="{'background-color':this.colors[4]}" @click="validar(4)" v-if="isHard"></div>
      <div class="square" :style="{'background-color':this.colors[5]}" @click="validar(5)" v-if="isHard"></div>
    </div>
  ...
  methods: {
    ...
    validar(posicion){      
      ...
      if(this.colors[posicion] == this.pickedColor){
        ...
        document.querySelectorAll('.square')[posicion].style.backgroundColor = '#232323'
